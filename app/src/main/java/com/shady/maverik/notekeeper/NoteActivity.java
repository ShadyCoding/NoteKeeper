...
import com.shady.maverik.notekeeper.NoteKeeperDatabaseContract.CourseInfoEntry;
import com.shady.maverik.notekeeper.NoteKeeperDatabaseContract.NoteInfoEntry;
import com.shady.maverik.notekeeper.NoteKeeperProviderContract.Courses;
import com.shady.maverik.notekeeper.NoteKeeperProviderContract.Notes;
...
public class NoteActivity extends AppCompatActivity
    ...
    public static final String NOTE_ID = "com.shady.maverik.notekeeper.NOTE_ID";
    public static final String NOTE_URI = "com.shady.maverik.notekeeper.NOTE_URI";
    public static final String ORIGINAL_NOTE_COURSE_ID = "com.shady.maverik.notekeeper.ORIGINAL_NOTE_COURSE_ID";
    public static final String ORIGINAL_NOTE_TITLE = "com.shady.maverik.notekeeper.ORIGINAL_NOTE_TITLE";
    public static final String ORIGINAL_NOTE_TEXT = "com.shady.maverik.notekeeper.ORIGINAL_NOTE_TEXT";
    ...
    private ModelStatusView mViewModelStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModelStatus = (ModelStatusView) findViewById(R.id.module_status);
    ...
    private void displayNote() {
        ...
        CourseEventBroadcastHelper.sendEventBroadcast(this, courseId, "Editing Notesh");
    }
    ...
    private void createNewNote() {
        AsyncTask<ContentValues, Integer, Uri> task = new AsyncTask<ContentValues, Integer, Uri>() {
            ...
            protected Uri doInBackground(ContentValues... params) {
                ...
                simulateLongRunningWork();// simulate slow down database work
                publishProgress(2);
            ...
            protected void onPostExecute(Uri uri) {
                Log.d(TAG, "call onPostExecute thread: " + Thread.currentThread().getId());
                mNoteUri = uri;
